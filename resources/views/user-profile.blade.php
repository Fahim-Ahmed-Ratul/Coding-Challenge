			...
			<div class="col-lg-12">
                ...
                @csrf
								<div class="form-group">
									...
									<input class="form-control" type="text" value="{{ $user->FullName }}" name="fullname" required="true">
								</div>
								<div class="form-group">
									<label>Email</label>
<input type="email" class="form-control" name="email" value="{{ $user->Email }}" required="true" readonly="true">
								</div>

								<div class="form-group">
									<label>Mobile Number</label>
									<input class="form-control" type="text" value="{{ $user->MobileNumber }}" required="true" name="contactnumber" maxlength="10">
								</div>
								<div class="form-group">
									<label>Registration Date</label>
									<input class="form-control" name="regdate" type="text" value="{{ $user->created_at }}" readonly="true">
								</div>
